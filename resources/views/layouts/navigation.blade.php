<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="mt-3">
                        {{-- <x-application-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" /> --}}<i class="fi fi-ss-book-bookmark text-xl "></i>
                    </a>
                </div>
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pertemuan.index')" :active="request()->routeIs('pertemuan.index')">
                        {{ __('Pertemuan') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('pertemuan.index')" :active="request()->routeIs('pertemuan.index')">
                {{ __('Pertemuan') }}
            </x-responsive-nav-link>
        </div>
